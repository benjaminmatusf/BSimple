                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                   ...
                                   <input type="text" name="nombreEmpresa" class="form-control" value="{{ $proveedor->nombreEmpresa }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                   ...
                                   <input type="text" name="direccionEmpresa" class="form-control" value="{{ $proveedor->direccionEmpresa }}">
                                </div>
                                </div>
                            ...
                            <div class="form-group">
                                   ...
                                   <input type="text" name="rutEmpresa" class="form-control" value="{{ $proveedor->rutEmpresa }}">
                                </div>
                                </div>
                            ...
                            <div class="form-group">
                                   ...
                                   <input type="text" name="nombreContacto" class="form-control" value="{{ $proveedor->nombreContacto }}">
                                </div>
                                </div>
